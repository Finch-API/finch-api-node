...
You can release to package managers by using [the `Publish NPM` GitHub action](https://www.github.com/Finch-API/finch-api-node/actions/workflows/publish-npm.yml). This will require a setup organization or repository secret to be set up.

...
export type PayStatementResponseBody =
  | PayStatementResponseBody.UnionMember0
  | PayStatementResponseBody.BatchError
  | PayStatementResponseBody.UnionMember2;

export namespace PayStatementResponseBody {
  export interface UnionMember0 {
    paging: UnionMember0.Paging;

    pay_statements: Array<UnionMember0.PayStatement>;
  }

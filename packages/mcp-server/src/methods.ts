...
export const sdkMethods: SdkMethod[] = [
  ...
  {
    clientCallName: 'client.hris.payStatementItem.list',
    fullyQualifiedName: 'hris.payStatementItem.list',
    httpMethod: 'get',
  ...
  {
    clientCallName: 'client.hris.payStatementItem.rules.update',
    fullyQualifiedName: 'hris.payStatementItem.rules.update',
    httpMethod: 'put',
    httpPath: '/employer/pay-statement-item/rule/{rule_id}',
  },
  {
    clientCallName: 'client.hris.payStatementItem.rules.list',
    fullyQualifiedName: 'hris.payStatementItem.rules.list',
    httpMethod: 'get',
    httpPath: '/employer/pay-statement-item/rule',
  },
  {
    clientCallName: 'client.hris.payStatementItem.rules.delete',
    fullyQualifiedName: 'hris.payStatementItem.rules.delete',
    httpMethod: 'delete',
    httpPath: '/employer/pay-statement-item/rule/{rule_id}',
  },
  {

...
const EMBEDDED_METHODS: MethodEntry[] = [
  {
    ...
    "response": "{ access_token: string; client_type: 'development' | 'production' | 'sandbox'; connection_id: string; connection_type: 'finch' | 'provider'; entity_ids: string[]; products: string[]; provider_id: string; token_type: string; account_id?: string; company_id?: string; customer_id?: string; customer_name?: string; }",
  ...
  },
  {
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.tryfinch.com/employer/company \\\n    -H 'Finch-API-Version: 2020-09-17' \\\n    -H \"Authorization: Bearer $ACCESS_TOKEN\""
      }
    }
  },
  {
    ...
    "response": "{ attributes: { metadata: object; employer?: boolean; pre_tax?: boolean; type?: string; }; category: 'earnings' | 'taxes' | 'employee_deductions' | 'employer_contributions'; name: string; }",
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.tryfinch.com/employer/pay-statement-item \\\n    -H 'Finch-API-Version: 2020-09-17' \\\n    -H \"Authorization: Bearer $ACCESS_TOKEN\""
      }
    }
  },
  {
    ...
    "response": "{ id?: string; attributes?: { metadata?: object; }; conditions?: { field?: string; operator?: 'equals'; value?: string; }[]; created_at?: string; effective_end_date?: string; effective_start_date?: string; entity_type?: 'pay_statement_item'; priority?: number; updated_at?: string; }",
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.tryfinch.com/employer/pay-statement-item/rule \\\n    -X POST \\\n    -H 'Finch-API-Version: 2020-09-17' \\\n    -H \"Authorization: Bearer $ACCESS_TOKEN\""
      }
    }
  },
  {
  ...
  },
  {
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.tryfinch.com/employer/pay-statement-item/rule/$RULE_ID \\\n    -X PUT \\\n    -H 'Finch-API-Version: 2020-09-17' \\\n    -H \"Authorization: Bearer $ACCESS_TOKEN\""
      }
    }
  },
  {
    ...
    "response": "{ id?: string; attributes?: { metadata?: object; }; conditions?: { field?: string; operator?: 'equals'; value?: string; }[]; created_at?: string; deleted_at?: string; effective_end_date?: string; effective_start_date?: string; entity_type?: 'pay_statement_item'; priority?: number; updated_at?: string; }",
  ...
  },
  {
    ...
    "response": "{ id: string; department: { name?: string; }; first_name: string; is_active: boolean; last_name: string; manager: { id: string; }; middle_name: string; }",
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.tryfinch.com/employer/directory \\\n    -H 'Finch-API-Version: 2020-09-17' \\\n    -H \"Authorization: Bearer $ACCESS_TOKEN\""
      }
    }
  },
  {
  ...
  },
  {
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.tryfinch.com/employer/individual \\\n    -X POST \\\n    -H 'Finch-API-Version: 2020-09-17' \\\n    -H \"Authorization: Bearer $ACCESS_TOKEN\""
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.tryfinch.com/employer/employment \\\n    -H 'Content-Type: application/json' \\\n    -H 'Finch-API-Version: 2020-09-17' \\\n    -H \"Authorization: Bearer $ACCESS_TOKEN\" \\\n    -d '{\n          \"requests\": [\n            {\n              \"individual_id\": \"individual_id\"\n            }\n          ]\n        }'"
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.tryfinch.com/employer/payment \\\n    -H 'Finch-API-Version: 2020-09-17' \\\n    -H \"Authorization: Bearer $ACCESS_TOKEN\""
      }
    }
  },
  {
    ...
    "response": "{ body: { paging: object; pay_statements: pay_statement[]; } | { code: number; message: string; name: string; finch_code?: string; } | { code: 202; finch_code: 'data_sync_in_progress'; message: 'The pay statements for this payment are being fetched. Please check back later.'; name: 'accepted'; }; code: number; payment_id: string; }",
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.tryfinch.com/employer/pay-statement \\\n    -H 'Content-Type: application/json' \\\n    -H 'Finch-API-Version: 2020-09-17' \\\n    -H \"Authorization: Bearer $ACCESS_TOKEN\" \\\n    -d '{\n          \"requests\": [\n            {\n              \"payment_id\": \"182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e\"\n            }\n          ]\n        }'"
      }
    }
  },
  {
    ...
    "response": "{ documents: { id: string; individual_id: string; type: 'w4_2020' | 'w4_2005'; url: string; year: number; }[]; paging: { offset: number; count?: number; }; }",
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.tryfinch.com/employer/documents \\\n    -H 'Finch-API-Version: 2020-09-17' \\\n    -H \"Authorization: Bearer $ACCESS_TOKEN\""
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.tryfinch.com/employer/documents/$DOCUMENT_ID \\\n    -H 'Finch-API-Version: 2020-09-17' \\\n    -H \"Authorization: Bearer $ACCESS_TOKEN\""
      }
    }
  },
  {
    ...
    "response": "{ benefit_id: string; description: string; frequency: 'every_paycheck' | 'monthly' | 'one_time'; type: string; company_contribution?: { tiers: { match: number; threshold: number; }[]; type: 'match'; }; }",
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.tryfinch.com/employer/benefits \\\n    -H 'Finch-API-Version: 2020-09-17' \\\n    -H \"Authorization: Bearer $ACCESS_TOKEN\""
      }
    }
  },
  {
  ...
  },
  {
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.tryfinch.com/employer/benefits/$BENEFIT_ID \\\n    -H 'Finch-API-Version: 2020-09-17' \\\n    -H \"Authorization: Bearer $ACCESS_TOKEN\""
      }
    }
  },
  {
  ...
  },
  {
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.tryfinch.com/employer/benefits/meta \\\n    -H 'Finch-API-Version: 2020-09-17' \\\n    -H \"Authorization: Bearer $ACCESS_TOKEN\""
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.tryfinch.com/employer/benefits/$BENEFIT_ID/enrolled \\\n    -H 'Finch-API-Version: 2020-09-17' \\\n    -H \"Authorization: Bearer $ACCESS_TOKEN\""
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.tryfinch.com/employer/benefits/$BENEFIT_ID/individuals \\\n    -H 'Finch-API-Version: 2020-09-17' \\\n    -H \"Authorization: Bearer $ACCESS_TOKEN\""
      }
    }
  },
  {
  ...
  },
  {
    ...
    "response": "{ id: string; display_name: string; products: string[]; authentication_methods?: { type: 'assisted' | 'credential' | 'api_token' | 'api_credential' | 'oauth' | 'api'; benefits_support?: object; supported_fields?: object; }[]; beta?: boolean; icon?: string; logo?: string; manual?: boolean; mfa_required?: boolean; primary_color?: string; }",
  ...
  },
  {
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.tryfinch.com/introspect \\\n    -H 'Finch-API-Version: 2020-09-17' \\\n    -H \"Authorization: Bearer $ACCESS_TOKEN\""
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.tryfinch.com/disconnect \\\n    -X POST \\\n    -H 'Finch-API-Version: 2020-09-17' \\\n    -H \"Authorization: Bearer $ACCESS_TOKEN\""
      }
    }
  },
  {
    ...
    "response": "{ request: { method: string; route: string; data?: string | object; headers?: object; params?: object; }; statusCode: number; data?: string; headers?: object; }",
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.tryfinch.com/forward \\\n    -H 'Content-Type: application/json' \\\n    -H 'Finch-API-Version: 2020-09-17' \\\n    -H \"Authorization: Bearer $ACCESS_TOKEN\" \\\n    -d '{\n          \"method\": \"method\",\n          \"route\": \"route\"\n        }'"
      }
    }
  },
  {
    ...
    "response": "{ data: { completed_at: string; created_at: string; job_id: string; job_url: string; params: object; scheduled_at: string; started_at: string; status: 'pending' | 'in_progress' | 'complete' | 'error' | 'reauth_error' | 'permissions_error'; type: 'data_sync_all' | 'w4_form_employee_sync'; }[]; meta: { quotas?: { data_sync_all?: object; }; }; }",
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.tryfinch.com/jobs/automated \\\n    -H 'Finch-API-Version: 2020-09-17' \\\n    -H \"Authorization: Bearer $ACCESS_TOKEN\""
      }
    }
  },
  {
    ...
    "response": "{ allowed_refreshes: number; remaining_refreshes: number; job_id?: string; job_url?: string; retry_at?: string; }",
    "perLanguage": {
      "typescript": {
  ...
  },
  {
    ...
    "response": "{ completed_at: string; created_at: string; job_id: string; job_url: string; params: { individual_id?: string; }; scheduled_at: string; started_at: string; status: 'pending' | 'in_progress' | 'complete' | 'error' | 'reauth_error' | 'permissions_error'; type: 'data_sync_all' | 'w4_form_employee_sync'; }",
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.tryfinch.com/jobs/automated/$JOB_ID \\\n    -H 'Finch-API-Version: 2020-09-17' \\\n    -H \"Authorization: Bearer $ACCESS_TOKEN\""
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.tryfinch.com/jobs/manual/$JOB_ID \\\n    -H 'Finch-API-Version: 2020-09-17' \\\n    -H \"Authorization: Bearer $ACCESS_TOKEN\""
      }
    }
  },
  {
    ...
    "response": "{ access_token: string; account_id: string; authentication_type: 'credential' | 'api_token' | 'oauth' | 'assisted'; company_id: string; connection_id: string; entity_id: string; products: string[]; provider_id: string; token_type?: string; }",
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.tryfinch.com/sandbox/connections \\\n    -H 'Content-Type: application/json' \\\n    -H 'Finch-API-Version: 2020-09-17' \\\n    -u \"$FINCH_CLIENT_ID:FINCH_CLIENT_SECRET\" \\\n    -d '{\n          \"provider_id\": \"provider_id\"\n        }'"
      }
    }
  },
  {
    ...
    "response": "{ access_token: string; account_id: string; authentication_type: 'credential' | 'api_token' | 'oauth' | 'assisted'; company_id: string; connection_id: string; entity_id: string; products: string[]; provider_id: string; }",
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.tryfinch.com/sandbox/connections/accounts \\\n    -H 'Content-Type: application/json' \\\n    -H 'Finch-API-Version: 2020-09-17' \\\n    -u \"$FINCH_CLIENT_ID:FINCH_CLIENT_SECRET\" \\\n    -d '{\n          \"company_id\": \"182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e\",\n          \"provider_id\": \"provider_id\"\n        }'"
      }
    }
  },
  {
    ...
    "response": "{ account_id: string; authentication_type: 'credential' | 'api_token' | 'oauth' | 'assisted'; company_id: string; connection_id: string; entity_id: string; products: string[]; provider_id: string; }",
  ...
  },
  {
    ...
    "response": "{ accounts: { account_name?: string; account_number?: string; account_type?: 'checking' | 'savings'; institution_name?: string; routing_number?: string; }[]; departments: { name?: string; parent?: { name?: string; }; }[]; ein: string; entity: { subtype?: 's_corporation' | 'c_corporation' | 'b_corporation'; type?: 'llc' | 'lp' | 'corporation' | 'sole_proprietor' | 'non_profit' | 'partnership' | 'cooperative'; }; legal_name: string; locations: { city: string; country: string; line1: string; line2: string; postal_code: string; state: string; name?: string; source_id?: string; }[]; primary_email: string; primary_phone_number: string; }",
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.tryfinch.com/sandbox/company \\\n    -X PUT \\\n    -H 'Content-Type: application/json' \\\n    -H 'Finch-API-Version: 2020-09-17' \\\n    -H \"Authorization: Bearer $ACCESS_TOKEN\" \\\n    -d '{\n          \"accounts\": [\n            {}\n          ],\n          \"departments\": [\n            {}\n          ],\n          \"ein\": \"ein\",\n          \"entity\": {},\n          \"legal_name\": \"legal_name\",\n          \"locations\": [\n            {\n              \"city\": \"city\",\n              \"country\": \"country\",\n              \"line1\": \"line1\",\n              \"line2\": \"line2\",\n              \"postal_code\": \"postal_code\",\n              \"state\": \"state\"\n            }\n          ],\n          \"primary_email\": \"dev@stainless.com\",\n          \"primary_phone_number\": \"primary_phone_number\"\n        }'"
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.tryfinch.com/sandbox/directory \\\n    -X POST \\\n    -H 'Finch-API-Version: 2020-09-17' \\\n    -H \"Authorization: Bearer $ACCESS_TOKEN\""
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.tryfinch.com/sandbox/individual/$INDIVIDUAL_ID \\\n    -X PUT \\\n    -H 'Finch-API-Version: 2020-09-17' \\\n    -H \"Authorization: Bearer $ACCESS_TOKEN\""
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.tryfinch.com/sandbox/employment/$INDIVIDUAL_ID \\\n    -X PUT \\\n    -H 'Finch-API-Version: 2020-09-17' \\\n    -H \"Authorization: Bearer $ACCESS_TOKEN\""
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.tryfinch.com/sandbox/payment \\\n    -X POST \\\n    -H 'Finch-API-Version: 2020-09-17' \\\n    -H \"Authorization: Bearer $ACCESS_TOKEN\""
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.tryfinch.com/sandbox/jobs \\\n    -H 'Content-Type: application/json' \\\n    -H 'Finch-API-Version: 2020-09-17' \\\n    -H \"Authorization: Bearer $ACCESS_TOKEN\" \\\n    -d '{\n          \"type\": \"data_sync_all\"\n        }'"
      }
    }
  },
  {
    ...
    "response": "{ completion_status: 'complete' | 'reauth_error' | 'permissions_error' | 'error'; type: 'data_sync_all'; }[]",
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.tryfinch.com/sandbox/jobs/configuration \\\n    -H 'Finch-API-Version: 2020-09-17' \\\n    -H \"Authorization: Bearer $ACCESS_TOKEN\""
      }
    }
  },
  {
  ...
  },
  {
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.tryfinch.com/employer/pay-groups \\\n    -H 'Finch-API-Version: 2020-09-17' \\\n    -H \"Authorization: Bearer $ACCESS_TOKEN\""
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.tryfinch.com/employer/pay-groups/$PAY_GROUP_ID \\\n    -H 'Finch-API-Version: 2020-09-17' \\\n    -H \"Authorization: Bearer $ACCESS_TOKEN\""
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.tryfinch.com/connect/sessions \\\n    -H 'Content-Type: application/json' \\\n    -H 'Finch-API-Version: 2020-09-17' \\\n    -u \"$FINCH_CLIENT_ID:FINCH_CLIENT_SECRET\" \\\n    -d '{\n          \"customer_id\": \"x\",\n          \"customer_name\": \"x\",\n          \"products\": [\n            \"benefits\"\n          ]\n        }'"
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.tryfinch.com/connect/sessions/reauthenticate \\\n    -H 'Content-Type: application/json' \\\n    -H 'Finch-API-Version: 2020-09-17' \\\n    -u \"$FINCH_CLIENT_ID:FINCH_CLIENT_SECRET\" \\\n    -d '{\n          \"connection_id\": \"connection_id\"\n        }'"
      }
    }
  }
];

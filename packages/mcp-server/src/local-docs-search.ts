...
const EMBEDDED_METHODS: MethodEntry[] = [
  ...
  },
  {
    ...
    response:
      "{ access_token: string; account_id: string; authentication_type: 'api_token' | 'assisted' | 'credential' | 'oauth'; company_id: string; connection_id: string; entity_id: string; products: string[]; provider_id: string; token_type: string; }",
    markdown:
